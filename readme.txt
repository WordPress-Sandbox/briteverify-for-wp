...
BriteVerify email verification service for WordPress.
...
1. Prevent Spam
1. Support for GravityForms
1. Support for Easy Digital Downloads Registration Form
...
**EDD Features:***
1. Enable/disable in registration fields.
...
Gravity Forms is a commercial WordPress plugin to create contact form. You can get it here http://www.gravityforms.com/

= What is Easy Digital Downloads (EDD) ? =

EDD is a free WordPress plugin to sell digital products with WordPress. You can get it here https://easydigitaldownloads.com/

= Where to get BriteVerify API Key =

You can get the API key from their website http://www.briteverify.com/ 

= Do this plugin support comment form? =

Currently No.

= Do this plugin support WordPress registration form? =
